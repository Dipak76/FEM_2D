...
% Get the nodes which are lying on the vertical line of symmetry as x-displacement is zero
for i = 1:nno
...
% Get the nodes which are lying on the horizontal line of symmetry as y-displacement is zero
for i = 1:nno
